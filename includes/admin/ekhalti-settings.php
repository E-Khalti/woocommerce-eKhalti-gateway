...
return apply_filters(
    ...
    'description' => array(
        ...
        'default' => __('Pay Securely with E-Khalti.com', 'ekhalti_gateway'),
        'desc_tip' => true,
    ),
    'merchant_id' => array(
    ...
    'api_key' => array(
        ...
        'type' => 'text',
        'description' => __('Enter with your API Key. You can get key from support@e-khalti.com', 'woocommerce-integration-demo'),
        'desc_tip' => true,
        'default' => ''
    ),
        )
